...
description: Use when the user asks to "work on dnsweaver", "modify dnsweaver", "add a dnsweaver provider", "add a dnsweaver source", "debug dnsweaver config", "deploy dnsweaver", or "update dnsweaver docs", or mentions the ~/repos/dnsweaver project. Provides repository-specific architecture, workflows, extension patterns, and operational guidance for dnsweaver.
version: 0.1.0
---
